...
const Featurs = () => {
  return (
    <div className="bg-slate-950 flex flex-col justify-center items-center text-white">
        <h1 className="text-center p-2 max-sm:w-[95%] w-1/2 bg-stone-900 rounded-lg text-4xl max-sm:text-2xl font-extrabold uppercase text-white">FEATURES ? 📱</h1>
